...
| Branch             | Last commit              | Behind / Ahead |
| ------------------ | ------------------------ | -------------- |
| main               | Bump axios to 1.7.4      | 0 / 0          |
| feat/billing-v2    | Add proration preview    | 0 / 14         |
| fix/race-on-replay | Drain queue before close | 3 / 2          |
...
| Customer     | Plan       | MRR    |
| ------------ | ---------- | ------ |
| Northwind    | Enterprise | $8,200 |
| Acme Corp    | Business   | $1,490 |
| Riverway Ltd | Team       | $580   |
...
| -------------------------------------------------------------------- | ------ | -------- | -------------- |
| ![](https://i.pravatar.cc/64?img=12)<br>Maya Singh<br>maya@acme.co   | Admin  | Jan 2024 | Active         |
| ![](https://i.pravatar.cc/64?img=13)<br>Mateo Reyes<br>mateo@acme.co | Editor | Mar 2024 | Active         |
| ![](https://i.pravatar.cc/64?img=5)<br>Sara Lin<br>sara@acme.co      | Viewer | May 2024 | Invite pending |
| ![](https://i.pravatar.cc/64?img=33)<br>Theo Wright<br>theo@acme.co  | Editor | Jun 2023 | Suspended      |
...
|     | Email         | Source          | Status    |
| --- | ------------- | --------------- | --------- |
|     | maya@acme.co  | Landing page    | Confirmed |
|     | mateo@acme.co | Referral · Sara | Confirmed |
|     | sara@acme.co  | Webinar · Q2    | Pending   |
...
| ------- | ----------- | ------------- | --------- |
| api     | production  | `v2.14.0`     | Healthy   |
| web     | production  | `v3.41.2`     | Degraded  |
| api     | staging     | `v2.15.0-rc1` | Deploying |
...
Team members
5 of 15 seats Invite

| Member                                                               | Role   | Last active | Status         | Actions |
| -------------------------------------------------------------------- | ------ | ----------- | -------------- | ------- |
| ![](https://i.pravatar.cc/64?img=68)<br>Alex Park<br>alex@acme.co    | Owner  | just now    | Active         |         |
| ![](https://i.pravatar.cc/64?img=12)<br>Maya Singh<br>maya@acme.co   | Admin  | 12 min ago  | Active         |         |
| ![](https://i.pravatar.cc/64?img=13)<br>Mateo Reyes<br>mateo@acme.co | Editor | 2 hours ago | Active         |         |
| ![](https://i.pravatar.cc/64?img=5)<br>Sara Lin<br>sara@acme.co      | Viewer | never       | Invite pending |         |
| ![](https://i.pravatar.cc/64?img=33)<br>Theo Wright<br>theo@acme.co  | Editor | 1 week ago  | Suspended      |         |
...
<div class="card w-full">
  ...
  <div class="table-responsive">
    <table class="table table--hover table--align-middle">
      ...
      <tbody>
        <tr>
          <td><div class="flex flex-wrap items-center gap-2"><img src="https://i.pravatar.cc/64?img=68" alt="" width="32" height="32" class="rounded-full" /><div><div>Alex Park</div><div class="text-muted-foreground">alex@acme.co</div></div></div></td>
        ...
        <tr>
          <td><div class="flex flex-wrap items-center gap-2"><img src="https://i.pravatar.cc/64?img=12" alt="" width="32" height="32" class="rounded-full" /><div><div>Maya Singh</div><div class="text-muted-foreground">maya@acme.co</div></div></div></td>
        ...
        <tr>
          <td><div class="flex flex-wrap items-center gap-2"><img src="https://i.pravatar.cc/64?img=13" alt="" width="32" height="32" class="rounded-full" /><div><div>Mateo Reyes</div><div class="text-muted-foreground">mateo@acme.co</div></div></div></td>
        ...
        <tr>
          <td><div class="flex flex-wrap items-center gap-2"><img src="https://i.pravatar.cc/64?img=5" alt="" width="32" height="32" class="rounded-full" /><div><div>Sara Lin</div><div class="text-muted-foreground">sara@acme.co</div></div></div></td>
        ...
        <tr>
          <td><div class="flex flex-wrap items-center gap-2"><img src="https://i.pravatar.cc/64?img=33" alt="" width="32" height="32" class="rounded-full" /><div><div>Theo Wright</div><div class="text-muted-foreground">theo@acme.co</div></div></div></td>
          <td><span class="badge badge--soft">Editor</span></td>
          <td>1 week ago</td>
          <td><span class="badge badge--soft badge--danger">Suspended</span></td>
          <td class="text-end"><button type="button" class="button button--sm button--ghost button--neutral button--icon-only" aria-label="More"><i data-lucide="more-horizontal"></i></button></td>
...
| Customer  | Plan       | Seats | MRR    | Started      | Renews | Owner      | Status   |
| --------- | ---------- | ----- | ------ | ------------ | ------ | ---------- | -------- |
| Acme Corp | Business   | 48    | $1,490 | Feb 02, 2024 | Aug 12 | Maya Singh | Active   |
| Northwind | Enterprise | 112   | $8,200 | Aug 30, 2022 | Oct 22 | Alex Park  | Active   |
| Globex    | Team       | 9     | $580   | Jun 01, 2024 | —      | Sara Lin   | Trialing |
...
| `--table-edge-padding`        | First/last column inset (lines up with the card gutter) |
